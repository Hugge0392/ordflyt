...
${urls}
  ...
  // Local uploads endpoint (for development)
  ...
  app.post("/api/upload-direct", requireAuth, requireCsrf, upload.single('file'), async (req: any, res) => {
    try {
      ...
      if (isLocalDev) {
        ...
        // Save metadata (mimetype and original filename)
        ...
        console.log("Local upload successful, objectPath:", objectPath, "filename:", req.file.originalname);
