...
export default function ReadingLessonViewer() {
  ...
  return (
    <TooltipProvider>
      ...
      {/* Header */}
      <div className="border-b bg-background">
        <div className={`max-w-7xl mx-auto p-4 transition-all duration-300 ${sidebarOpen ? 'lg:ml-80 lg:mr-4' : 'lg:ml-20 lg:mr-4'}`}>
      ...
      {/* Content */}
      <div className={`max-w-7xl mx-auto p-6 transition-all duration-300 ${sidebarOpen ? 'lg:ml-80 lg:mr-4' : 'lg:ml-20 lg:mr-4'}`}>
        {/* Lesson Info */}
        <Card className="mb-6">
          <CardHeader>
